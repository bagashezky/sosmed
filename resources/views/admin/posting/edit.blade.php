...
@section('content')
    <div class="row">
        <div class="col-12">
            {{ Form::model($posting,['route'=>['posting.update',$posting['id']], 'files'=>true,'method'=>'PUT']) }}
                <div class="card">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="col-12">
                                    ...
                                    {{ Form::textarea('caption', $posting['caption'], ['class'=>'form-control', 'placeholder'=>'Enter caption', 'rows'=>5]) }}
                                </div>
